...
**Отдельная диаграмма для первого негативного сценария - "чужой" заказ:**
...
**Отдельная диаграмма для второго негативного сценария - "повторный" заказ (перезапись параметров первоначальной задачи):**
...
**Отдельная диаграмма для третьего негативного сценария - бездействие:**
![Негативные сценарии](./pics/sd_3.png?raw=true "")

Нарушается Бизнес-функция.
Компенсация представляется невозможной.

**Отдельная диаграмма для четвертого негативного сценария - code injection:**
...
**Отдельная диаграмма для пятого негативного сценария - атака на зависимости:**
...
**Отдельная диаграмма для шестого негативного сценария - брутфорс пароля:**
...
**Отдельная диаграмма для седьмого негативного сценария - фишинг:**
...
**Отдельная диаграмма для восьмого негативного сценария - атака на mobile:**
...
**Отдельная диаграмма для девятого негативного сценария - ddos:**
