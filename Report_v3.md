...
Рассматривая их детально были сделаны следующие выводы:
 - Физический доступ к смартфону предовратить не удастся, следовательно, его необходимо делать защищенным - т.е. использовать для блокировки сложные пароли/биометрические данные, можно даже использовать виртуализацию и прочие методы защиты на Android, чтобы сломать злоумышленнику мозг и усложнить жизнь. 
